    ...
    public partial class Fornecimento_equipamento_menu : Form
    {
        ...
        public Fornecimento_equipamento_menu()
        {
            ...
            try
            {
                ...
                {
                    sqlCon1.Open();
                    SqlDataAdapter sqlDa1 = new SqlDataAdapter("SELECT id_fornecimento as 'Id', denominacao as 'Denominação',numero_serie as 'Número de série',lote as 'Lote',quantidade_fornecimento as 'Qtd', fabricante as 'Fabricante',email_tel_fabricante as 'Contacto do Fabricante', data_entrega as 'Data limite de receção', entidade as 'Entidade' FROM Equipamentos inner join fornecimento_equipamento ON Equipamentos.id = fornecimento_equipamento.id_fornecimento", sqlCon1);
        ...
        private void textbox_searchbar_Leave(object sender, EventArgs e)
        {
            if (textbox_searchbar.Text == "")
            {
                ...
                try
                {
                    ...
                    {
                        sqlCon1.Open();
                        SqlDataAdapter sqlDa1 = new SqlDataAdapter("SELECT id_fornecimento as 'Id', denominacao as 'Denominação',numero_serie,lote,quantidade_fornecimento as 'Qtd', fabricante as 'Fabricante',email_tel_fabricante as 'Contacto do Fabricante', data_entrega as 'Data limite de receção', entidade as 'Entidade' FROM Equipamentos inner join fornecimento_equipamento ON Equipamentos.id = fornecimento_equipamento.id_fornecimento", sqlCon1);
                        DataTable dtbl1 = new DataTable();
                        sqlDa1.Fill(dtbl1);
                        dataGridView1.DataSource = dtbl1;
                        sqlCon1.Close();
