...
namespace DLS_ALFEITE
{
    public partial class Inflamáveis : Form
    {
        ...
        public void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                Editar_inflamavel editar_inflamavel = new Editar_inflamavel(id, denominacao, validade, lote, stock, numero_serie, fabricante, contacto_do_fabricante, observacoes, setor, this,check);
